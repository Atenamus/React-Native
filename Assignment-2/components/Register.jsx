...
const Register = () => {
  ...
  return (
    <View className="flex justify-center items-center mx-6 mt-4 space-y-4">
      ...
      <Text className="text-5xl my-4 font-semibold">Create an Account</Text>
      <View className="w-[327px] gap-1">
        <Text className="text-xl pl-2">Name</Text>
        <TextInput
      ...
      <TouchableHighlight
        ...
        onPress={handlePress}
      >
        <Text className="text-white text-center text-2xl">Create</Text>
      </TouchableHighlight>
    </View>
  );
};
